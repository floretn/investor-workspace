package ru.mephi.iw.ui.beans.users;
...
public class UsersViewBean implements Serializable {
    ...
    public String prepareForUpdate(CurrentUserInfo currentUserInfo) {
        return "/ru/mephi/iw/users/UserInfoChange.xhtml?id=" + currentUserInfo.getId() + "faces-redirect=true";
    }
    ...
    public void updateUserList() {
        usersInfo = usersInfoInDB.parallelStream().filter(u -> username.equals("") || u.getUser().getUsername()
                .toLowerCase(Locale.ROOT).contains(username.toLowerCase(Locale.ROOT)))
